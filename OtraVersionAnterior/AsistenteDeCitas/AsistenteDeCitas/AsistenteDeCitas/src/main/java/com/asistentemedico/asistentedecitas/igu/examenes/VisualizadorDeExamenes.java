...
public class VisualizadorDeExamenes extends javax.swing.JFrame {
    ...
    public VisualizadorDeExamenes(String nombreUsuario, String apellidoUsuario) {
        initComponents();
    ...
    private void setModelo(){
        String[] cabecera={"Nombre", "Apellido(s)" , "IdenTExamen",
        "TicketExamen", "Costo", "TipoExa" , "Descripcion" ,"Pago?",
        "Asistido?"};
    ...
    private void initComponents() {
        ...
        CancelarCita.setText("Cancelar Examen");
        ...
        visualizador.setForeground(new java.awt.Color(0, 102, 102));
     ...
     private void leerCitasUsuario() {
        ...
        new BufferedReader(new FileReader("src/main/java/com/asistentemedico/asistentedecitas/persistencia/examenes.txt"))) {
        String linea;
        while ((linea = br.readLine()) != null) {
            String[] campos = linea.split(", ");
            String nombreUsuario1 = campos[0];
            String apellidoUsuario1 = campos[1];
            if (nombreUsuario1.equals(nombreUsuario) &&
                apellidoUsuario1.equals(apellidoUsuario)) {
    ...
    private void CancelarCitaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelarCitaActionPerformed
        this.dispose();
        CancelacionDeExamenesPagos cancel = new CancelacionDeExamenesPagos(nombreUsuario, apellidoUsuario);
    ...
    private void volverBotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volverBotonActionPerformed
        EntradadeExamenes inix= new EntradadeExamenes();
        this.dispose();
