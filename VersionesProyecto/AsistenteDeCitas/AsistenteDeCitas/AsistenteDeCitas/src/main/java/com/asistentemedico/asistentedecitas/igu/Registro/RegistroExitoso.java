...
public class RegistroExitoso extends javax.swing.JFrame {
    public RegistroExitoso(Usuario usuario) {
        initComponents();
        cargarDatosUsuario(usuario);
        bloquearCampos();
        jRadioButton1.setSelected(true); 
        // Marcar el botón de radio por defecto
        jRadioButton1.setEnabled(false); 
        // Deshabilitar la interacción con el botón de radio
    }
    ...
    private void initComponents() {
        ...
        inicioSesionLuegoDeRegistroExitoso = new javax.swing.JButton();
        ...
        registrarbotom.setText("Registro Exitoso");
        ...
        inicioSesionLuegoDeRegistroExitoso.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        inicioSesionLuegoDeRegistroExitoso.setForeground(new java.awt.Color(0, 102, 102));
        inicioSesionLuegoDeRegistroExitoso.setText("Iniciar Sesion");
        inicioSesionLuegoDeRegistroExitoso.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inicioSesionLuegoDeRegistroExitosoActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(inicioSesionLuegoDeRegistroExitoso)
                                .addGap(18, 18, 18)
    ...
    private void inicioSesionLuegoDeRegistroExitosoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inicioSesionLuegoDeRegistroExitosoActionPerformed
        this.dispose();
        InicioDeSesion inic= new InicioDeSesion();
        inic.setVisible(true);
        inic.setLocationRelativeTo(null);
        inic.setResizable(false);
    }//GEN-LAST:event_inicioSesionLuegoDeRegistroExitosoActionPerformed
    ...
    private javax.swing.JButton inicioSesionLuegoDeRegistroExitoso;
