...
public class EntradadePasarASalaDeEspera extends javax.swing.JFrame {
    ...
    private void pasarALaSalaDeEsperaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasarALaSalaDeEsperaActionPerformed
        ...
        if (GestordeSala.usuarioEnSalaEspera(nombreUsuario, 
              apellidoUsaurio, identificacion, 
              identificadorCita, ticketCita)) {
        this.dispose();
        SalaDeEspera sala = new SalaDeEspera(nombreUsuario, apellidoUsaurio, 
                identificacion, ticketCita);
        ...
        if (GestordeSala.verificarDatosCita
        (nombreUsuario, apellidoUsaurio, identificacion, 
                identificadorCita, ticketCita) &&
                GestordeSala.verificarCitaPaga(identificadorCita)) {
            if(GestordeSala.verificarEstadoCita(identificadorCita, "No asistida") )
            {
        this.dispose();
        SalaDeEspera sala = new SalaDeEspera(nombreUsuario, apellidoUsaurio
        , identificacion, ticketCita);
        ...
        GestordeSala.guardarUsuarioSalaEspera(nombreUsuario, apellidoUsaurio,
                identificacion, identificadorCita,ticketCita);
            }
            else{
            this.dispose();
            ErrorAlPasarASala sala = new ErrorAlPasarASala(nombreUsuario, apellidoUsaurio, identificacion, identificadorCita, ticketCita);
            sala.setVisible(true);
            sala.setLocationRelativeTo(null);
            sala.setResizable(false);
            }
        ...
        {
        this.dispose();
        ErrorAlPasarASala sala = new ErrorAlPasarASala(nombreUsuario, 
