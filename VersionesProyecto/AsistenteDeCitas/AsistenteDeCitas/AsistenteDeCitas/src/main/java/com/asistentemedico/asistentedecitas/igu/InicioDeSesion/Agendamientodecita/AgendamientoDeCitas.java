...
public class AgendamientoDeCitas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ConfirmarCita.setForeground(new java.awt.Color(0, 102, 102));
        ...
        CancelarCita1.setForeground(new java.awt.Color(0, 102, 102));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(CancelarCita1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    if (doctorArango.isSelected()) doctorSeleccionado1 
            += doctorArango.getText() + ", ";
    if (doctorJeison.isSelected()) doctorSeleccionado1 
            += doctorJeison.getText() + ", ";
    if (doctorJuanCarlos.isSelected()) doctorSeleccionado1 
            += doctorJuanCarlos.getText() + ", ";
    ...
    confirmacionDelAgendamientoDeLaCita confir = 
       ...
       pagarSeleccionado, doctorSeleccionado1
    );
    ...
    private int generarIdentificadorDeCita(){
    ...
    try {
        FileReader fr = new FileReader("src/main/java/com/asistentemedico/asistentedecitas/persistencia/citas.txt");
        BufferedReader br = new BufferedReader(fr);

        int contador = 0;

        // Leer cada línea del archivo y contar las citas existentes para la identificación actual
        String linea;
        ...
        // Construir el siguiente número de cita
    ...
    private void marcarBotones(String especialidadMotivoSeleccionados) {
        ...
        String[] especialidadMotivo = 
                especialidadMotivoSeleccionados.split(", ");
        ...
        if (especialidadMotivo.length > 0) {
            String motivo = 
                    especialidadMotivo[especialidadMotivo.length - 1];
