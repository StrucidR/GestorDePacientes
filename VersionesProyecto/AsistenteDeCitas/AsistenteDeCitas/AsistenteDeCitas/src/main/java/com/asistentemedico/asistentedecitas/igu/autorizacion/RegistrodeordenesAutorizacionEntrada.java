...
public class RegistrodeordenesAutorizacionEntrada extends javax.swing.JFrame {
    public RegistrodeordenesAutorizacionEntrada() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        AutorizarExamenes.setForeground(new java.awt.Color(0, 102, 102));
        AutorizarExamenes.setText("Autorizar");
                    ...
                    apellidoUsuario, identificacion, contrasenia))
            {
               ...
               (identificadorCita, ticket);
                ...
                if(citaPaga && citaAsistida)
                {
                 ...
                 this.dispose();
                 CredencialesValidasInformacionRespectoALaAutorizacion sala = 
                 new CredencialesValidasInformacionRespectoALaAutorizacion(
