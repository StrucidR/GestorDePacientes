...
public class ustedYaCuentaconUnExamen extends javax.swing.JFrame {
    public ustedYaCuentaconUnExamen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Usted ya cuenta con un examen por favor dirijase a la sala de espera");
    ...
    private boolean validarDatosParaAgendarExamen() {
    ...
    if (nombreUsuario.isEmpty() || apellidoUsuario.isEmpty() ||
        identificacion.isEmpty() || 
         password1.isEmpty()  || identificacion2.isEmpty() || ticket.isEmpty() ||
             informacionAlrespectodelexamen.isEmpty()) {
        return false;
    }
