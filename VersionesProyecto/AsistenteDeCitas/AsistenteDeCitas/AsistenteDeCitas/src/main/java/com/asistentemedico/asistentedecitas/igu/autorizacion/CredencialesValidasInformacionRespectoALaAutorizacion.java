...
public class CredencialesValidasInformacionRespectoALaAutorizacion extends javax.swing.JFrame {
    ...
    public CredencialesValidasInformacionRespectoALaAutorizacion(
            ...
            String descripcion, int identificadordeautorizacion) {
        ...
        textArea.setWrapStyleWord(true); // Ajusta las líneas por palabras enteras
        textArea.setColumns(40); // Establece el número de columnas
        textArea.setRows(10); // Establece el número de filas
    }
    ...
    private void pasarALaSalaDeEsperaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasarALaSalaDeEsperaActionPerformed
        this.dispose();
        RegistrodeordenesAutorizacionEntrada sala = new RegistrodeordenesAutorizacionEntrada();
    ...
    private void pasarALaSalaDeEspera1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasarALaSalaDeEspera1ActionPerformed
        this.dispose();
        Primeraentradaenexamenes sala = new Primeraentradaenexamenes();
        sala.setVisible(true);
        sala.setLocationRelativeTo(null);
        sala.setResizable(false);        
