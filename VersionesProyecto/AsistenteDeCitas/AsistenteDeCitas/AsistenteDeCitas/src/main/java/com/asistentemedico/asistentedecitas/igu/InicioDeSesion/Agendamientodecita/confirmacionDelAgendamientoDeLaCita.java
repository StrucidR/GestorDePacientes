...
public class confirmacionDelAgendamientoDeLaCita extends javax.swing.JFrame {
    ...
    public confirmacionDelAgendamientoDeLaCita(String nombreUsuario, 
            ...
            int costo1, boolean pagarSeleccionado, String doctorSeleccionado) {
        ...
        marcarBotones1(doctorSeleccionado);
    ...
    private void initComponents() {
        ...
        SaladEspera.setForeground(new java.awt.Color(0, 102, 102));
        ...
        Agendar.setForeground(new java.awt.Color(0, 102, 102));
        ...
        CancelarCita3.setForeground(new java.awt.Color(0, 102, 102));
    ...
    String doctorSeleccionado = obtenerDoctorSeleccionado();
    ...
    String cita = nombre + ", " + apellido + ", " + identificacionUsuario + 
            ...
            doctorSeleccionado + ", " + (citaPaga ? "Paga" : "No Paga") + ", " +
            especialidadMotivo + ", " + asistencia;
    ...
    {
    StringBuilder especialidadMotivo = new StringBuilder();
    if (boton1.isSelected()) 
    {
        especialidadMotivo.append(boton1.getText()).append(", ");
    }
    if (boton2.isSelected()) 
    {
        especialidadMotivo.append(boton2.getText()).append(", ");
    }
    if (boton3.isSelected()) 
    {
        especialidadMotivo.append(boton3.getText()).append(", ");
    }
    if (boton4.isSelected()) 
    {
        especialidadMotivo.append(boton4.getText()).append(", ");
    }
    if (boton5.isSelected()) 
    {
        especialidadMotivo.append(boton5.getText()).append(", ");
    }
    if (motivo1.isSelected()) 
    {
        especialidadMotivo.append(motivo1.getText());
    } 
    else if (motivo2.isSelected()) 
    {
        especialidadMotivo.append(motivo2.getText());
    } 
    else if (motivo3.isSelected()) 
    {
        especialidadMotivo.append(motivo3.getText());
    }
    return especialidadMotivo.toString();
}
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (String esp : especialidadMotivo) {
            if (esp.equals(boton1.getText())) boton1.setSelected(true);
            if (esp.equals(boton2.getText())) boton2.setSelected(true);
            if (esp.equals(boton3.getText())) boton3.setSelected(true);
            if (esp.equals(boton4.getText())) boton4.setSelected(true);
            if (esp.equals(boton5.getText())) boton5.setSelected(true);
        }
        
        // Marcar el botón de motivo
        if (especialidadMotivo.length > 0) {
            String motivo = especialidadMotivo[especialidadMotivo.length - 1];
            if (motivo.equals(motivo1.getText())) 
                motivo1.setSelected(true);
            if (motivo.equals(motivo2.getText()))
                motivo2.setSelected(true);
            if (motivo.equals(motivo3.getText())) 
                motivo3.setSelected(true);
        }
    }
        
        private void marcarBotones1(String doctorSeleccionado){
            String[] doctor=doctorSeleccionado.split(", ");
                    for (String esp : doctor) {
            if (esp.equals(doctorArango.getText())) 
                doctorArango.setSelected(true);
            if (esp.equals(doctorJuanCarlos.getText())) 
                doctorJuanCarlos.setSelected(true);
            if (esp.equals(doctorJeison.getText())) 
