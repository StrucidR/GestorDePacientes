...
public class visualizarCitas extends javax.swing.JFrame {
    ...
    cabecera.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente = new Nodo("Motivo");
    cabecera.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente.siguiente = new Nodo("Asistida?");
