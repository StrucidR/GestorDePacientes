...
public class ExamenAtendidoConExito extends javax.swing.JFrame {
    
    private String identificadordeautorizacion;
    
    
    public ExamenAtendidoConExito(String identificadordeautorizacion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        DoctorFree2.setText("EXAMEN ATENDIDO");
