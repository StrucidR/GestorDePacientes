...
public class Cita {
    ...
    public String toString() {
        return "Cita{" + "nombre=" + nombre + ", apellido=" + apellido + ", identificacion=" + identificacion + ", identificador=" + identificador + ", ticket=" + ticket + ", costo=" + costo + ", doctor=" + doctor + ", estado=" + estado + ", especialidad=" + especialidad + ", asistencia=" + asistencia + ", motivo=" + motivo + '}';
    }
}
