...
public class EstadoParaSalaDeCitasAtencionMedica {
    ...
    public EstadoParaSalaDeCitasAtencionMedica(String nombre, String apellido, String identificacion, String estadoDeFlujo) {
        this.nombre = nombre;
