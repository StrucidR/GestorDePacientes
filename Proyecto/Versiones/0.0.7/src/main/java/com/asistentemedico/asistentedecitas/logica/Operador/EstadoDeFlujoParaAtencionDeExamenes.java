...
public class EstadoDeFlujoParaAtencionDeExamenes {
    ...
    public EstadoDeFlujoParaAtencionDeExamenes(String nombre, String apellido, String identificacion, String estadoDeFlujo) {
        this.nombre = nombre;
