...
public class EstadoDeFlujoParaAutorizaciones {
    ...
    public EstadoDeFlujoParaAutorizaciones(String nombre, String apellido, String identificacion, String estadoDeFlujo) {
        this.nombre = nombre;
