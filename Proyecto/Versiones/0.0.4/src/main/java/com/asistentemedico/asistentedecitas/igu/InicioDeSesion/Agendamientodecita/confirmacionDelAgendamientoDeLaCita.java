...
public class confirmacionDelAgendamientoDeLaCita extends javax.swing.JFrame {
    ...
    //Pasamos los datos con base al anterior frame
    public confirmacionDelAgendamientoDeLaCita(String nombreUsuario, 
        ...
        //los inicializamos y desactivamos los anteriores
        //tambien copiamos y pegamos el mismo funcionamiento de metodo
        //para hacer la correcta marcación
        disableComponents();
    }
    ...
    //guardamos la cita con base a lo que se visualiza inicialemnte, la asistencia
    ...
    //OBTENEMOS EL DOCTOR CON FORME A LA SELECCION COMO TEXTO
    //PARA PODER ALMACENAR CON PERSISTENCIA
    ...
    //MARCAMOS LOS BOTONES POR ESPECIALIDAD CON FORME AL USUARIO MARCO ANTERIORMENTE
