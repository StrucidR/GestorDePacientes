...
public class PasarASalaDeAutorizacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pasarASala.setForeground(new java.awt.Color(0, 102, 153));
        ...
        identificadorEntrada.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N

        etiquetaTiempo.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        etiquetaTiempo.setForeground(new java.awt.Color(0, 102, 153));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(Precio, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 197, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void lobbybotonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lobbybotonActionPerformed
        String nombreDelUsuario = nombreEntrada.getText();
        String apellidoDelUsuario = ApellidoEntrada.getText();
        String identificacionDelUsuario = IdentificacionEntrada.getText();
        String identificadorDeLaCita = IdentificadorDeCitaEntrada.getText();
        String ticketDeLaCita = ticketEntrada.getText();
        
        GestorAutorizacion.eliminarAutorizacion(nombreDelUsuario, 
        apellidoDelUsuario, identificacionDelUsuario, identificadorDeLaCita, 
        ticketDeLaCita);
        this.dispose();
    ...
    private void pasarASalaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pasarASalaActionPerformed
        ...
        boolean estaEnSala =
        GestorAutorizacion.usuarioEnSala
        (nombreUsuario, apellidoUsuario, identificacion, identificadorDeCita, ticket, textIdentificadorAutorizacion);
