...
public class GestorAutorizacion {
    ...
    public static boolean usuarioEnSala(String nombre, String apellido,
    String identificacion, String identificadorDeLaCida, String ticket,
    String identificadordeautorizacion){
    DoblementeEnlazada<SalaDeAutorizaciones> citas = cargarSalaDeAutorizacionesDesdeArchivo(RUTA_ARCHIVO);
    Nodo<SalaDeAutorizaciones> nodoActual = citas.getCabeza();
    while(nodoActual != null){
        SalaDeAutorizaciones citaActual = nodoActual.getValor();
        if(citaActual.getNombreUsuario().equals(nombre) &&
           ...
           citaActual.getIdentificadordecita().equals(identificadorDeLaCida) &&
           citaActual.getTicketdecita().equals(ticket) && 
           citaActual.getIdentificadordeautorizacion().equals(identificadordeautorizacion)){
            return true;
        }
        nodoActual = nodoActual.getSiguiente();
    }
    ...
    //DOCUMENTAR DE FORMA PRECISA NO TAN COMPLETA 
