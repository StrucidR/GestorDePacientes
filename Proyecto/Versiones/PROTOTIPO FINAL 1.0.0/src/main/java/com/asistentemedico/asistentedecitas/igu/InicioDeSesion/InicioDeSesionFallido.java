...
public class InicioDeSesionFallido extends javax.swing.JFrame {
    
    public InicioDeSesionFallido() {
        initComponents();
        bloquearCampos();//Metodo de bloquear campos simplificando que el 
    }//usuario no se equivoque volviendo a escribir las credenciales
    ...
    private void initComponents() {
        ...
        jLabel23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Imagenlogo.png"))); // NOI18N
        ...
        iniciarSesionboton.setText("Volver");
        iniciarSesionboton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                iniciarSesionbotonActionPerformed(evt);
            }
        ...
        jLabel22.setText("Ingreso Fallido, Por favor verificar credenciales y/o registrarse");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(sobreNosotros, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(353, 353, 353)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addComponent(iniciarSesionboton))
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(identificacionEntrada1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(passwordEntrada1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(93, 93, 93)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void limpiarBotomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_limpiarBotomActionPerformed
       nombreEntrada.setText("");//Limpiamos las entradas que esperan los 
       apellidoEntrada1.setText("");//respetivos parametros para garantizar 
       identificacionEntrada1.setText("");//que no exista un almacenado de 
       passwordEntrada1.setText("");//algun dato
   
       this.dispose();
       InicioDeSesion inicios=new InicioDeSesion();
       inicios.setVisible(true);
       inicios.setLocationRelativeTo(null);
       inicios.setResizable(false);
    ...
    private void bloquearCampos(){//bloqueamos los campos con el metodo
        nombreEntrada.setEnabled(false);//interno setEnabl. dejandolo en 
        apellidoEntrada1.setEnabled(false);//false
