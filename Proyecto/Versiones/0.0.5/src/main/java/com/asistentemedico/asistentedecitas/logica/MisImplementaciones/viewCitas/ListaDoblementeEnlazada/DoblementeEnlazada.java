...
public void eliminarDelMedioPorTicketCitasEnEsperaDePago(String ticket){
    Nodo<T> nodoActual = cabeza;
    while(nodoActual != null){
        SalaDePago cita = (SalaDePago) nodoActual.getValor();
...
public void eliminarDelMedioEnSalaDeAtencionDeExamenes(String identificadorDeExamen){
    ...
    while(nodoActual != null){
        ...
        if(sala.getTicketExamen().equals(identificadorDeExamen)){
            if(nodoActual == cabeza){
                eliminarDelInicio();
            }
            else if(nodoActual == cola){
    ...
    public Nodo<T> getCabeza() {
        ...
        public Iterator<T> iterator(){
           return new IteradorDoblementeEnlazada(cabeza);
        }
        
        private class IteradorDoblementeEnlazada implements Iterator<T>{
            
            private Nodo<T> nodoActual;
            
            public IteradorDoblementeEnlazada(Nodo<T> cabeza){
