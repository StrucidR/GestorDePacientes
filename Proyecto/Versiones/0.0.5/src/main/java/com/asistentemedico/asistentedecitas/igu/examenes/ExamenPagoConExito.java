...
public class ExamenPagoConExito extends javax.swing.JFrame {
    
    private String identificadordeautorizacion;
    
    public ExamenPagoConExito(String identificadordeautorizacion) {
        initComponents();
    ...
    private void initComponents() {
        ...
        DoctorFree2.setText("PAGO DE EXAMEN EXITOSO");
