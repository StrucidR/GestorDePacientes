    ...
    if (validarCampos()) {//si los campos son aptos entonces 
         ...
         if(ControladorUsuario.validarInicioSesion(nombre, apellido, 
            identificacion, contrasenia)){//Una condición donde validamos gracias al metodo validarInicio.. con
             ...
             if(nombre.equals("Operador") && apellido.equals("123") &&
                identificacion.equals("123") && contrasenia.equals("operador123")){
                 this.dispose();
                 InicioDeSesionExitosoParaElOperador inic = 
                 new InicioDeSesionExitosoParaElOperador(nombre, apellido, identificacion);
