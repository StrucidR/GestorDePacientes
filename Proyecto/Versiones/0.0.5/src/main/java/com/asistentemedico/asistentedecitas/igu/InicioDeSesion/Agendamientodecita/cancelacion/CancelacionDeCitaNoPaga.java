...
public class CancelacionDeCitaNoPaga extends javax.swing.JFrame {
    ...
    public CancelacionDeCitaNoPaga(String nombreUsuario, String apellidoUsuario,
        ...
        //En este caso la logica es muy similar que al agendamiento un filtro de
        //frames que se evaluan buscando lo que el usuario quiere hacer con respec
        //to a la opcion seleccionada
        disableComponents();
    }
    @Override
    ...
    //Marcamos botones con base al parametro que le pasamos obteniendo el texto
    //del anterior opcion ya seleccionada y compara con los botones obteniendo su
    //respectivo texto
    ...
    //metodo para desactivar botones ya que eso se hace con base a lo anterior
         //y el usuario una vez ya identificada la cita que no ha sido paga
         //no vuelva a seleccionar solamente regresandose evitando errores de
         //cancelacion
    ...
    private void PagoDeCitasboton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PagoDeCitasboton1ActionPerformed
        ...
        prim.setVisible(true);
        prim.setLocationRelativeTo(null);
        prim.setResizable(false);//Logica para pasar a los otros frames cirra 
        //la ventana inicial y inicializamos la otra en el centro sin ser renderizada
        //o movil y sin ampliar evitando errores de compartimiento de pantalla
